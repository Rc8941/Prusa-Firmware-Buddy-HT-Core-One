...
#define STRING_CONFIG_H_AUTHOR "(Rc, HT config)" // Who made the changes.
 ...
 */
#define TEMP_SENSOR_0 1010 // 1010 (PT1000 1k pullup) When ready, 2005 stock
...
#define HEATER_0_MAXTEMP 510 // 500c settable max, 510 shutoff
#define HEATER_1_MAXTEMP 275
#define HEATER_2_MAXTEMP 275
#define HEATER_3_MAXTEMP 275
#define HEATER_4_MAXTEMP 275
#define HEATER_5_MAXTEMP 275
#define HEATER_MAXTEMP_SAFETY_MARGIN 10 // Lowered so the hotend can't go a whole 15c above what everything's rated for.
#define BED_MAXTEMP 140 // Try to stay within normal 115c settable limits, but if needed this is increased slightly. Presumption that this doesn't burn out anything is from Metacolin's MK4 HT upgrade, not trying it on my own printer.
#define BED_MAXTEMP_SAFETY_MARGIN 5
#define HEATBREAK_MAXTEMP 100
#define CHAMBER_MAXTEMP 100 // Don't know why this is 100 or where the setable 55c comes from
